...
const ham = document.querySelector(".main-container header .ham");
const nav = document.querySelector(".main-container header .main-nav .nav-container");
ham.addEventListener('click',()=>{
  nav.classList.toggle('nav-toggle');
  ham.classList.toggle('on-ham');
  console.log("done");
})